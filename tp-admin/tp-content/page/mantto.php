...
<!--Inicia header del panel -->
     <title>Mantenimiento - &#84;&#97;&#99;&#104;&#105; &#65;&#100;&#109;&#105;&#110; &#80;&#97;&#110;&#101;&#108;</title>
...
<div id="container">
    ...
    <?php include ('tp-content/modulos/navbar.php'); ?>   <!--Termina menú del panel -->
...
<ul class="menu">
     <li class=""><a href="#">Nuevo admin</a></li>
     <li class=""><a href="#">Mapas en linea</a></li>
     <li class=""><a href="#">Información de jugadores</a></li>
</ul></div></div>
...
<?php
   if (isset($_GET['modulo'])) {
        $page = $_GET['modulo'];
        if (file_exists("tp-content/modulos/mantto/$page.php")) { include ( "tp-content/modulos/mantto/$page.php");
         }
        else { 
           print "<h2>Pagina no encontrada.</h2>"; 
             } 
    }
   else { include ("tp-content/modulos/page/creditos.php");
    }
?>

...
<!--Inicia header del panel -->
     <title>Tanys - &#84;&#97;&#99;&#104;&#105; &#65;&#100;&#109;&#105;&#110; &#80;&#97;&#110;&#101;&#108;</title>
...
<div class="title">Tanys y premios</div>
<ul class="menu">
     <li class=""><a href="tany.php?modulo=addtaney">Envio de Tanys a cuenta</a></li>
     <li class=""><a href="tany.php?modulo=alltaney">Tanys para todos</a></li>
     <li class=""><a href="tany.php?modulo=additem">Envio de Items a cuenta</a></li>
     <li class=""><a href="tany.php?modulo=allitem">Item para todos</a></li>
     </ul></div></div>
...
<?php
   if (isset($_GET['modulo'])) {
        $page = $_GET['modulo'];
        if (file_exists("tp-content/modulos/taneys/$page.php")) { include ( "tp-content/modulos/taneys/$page.php");
         }
        else { 
           print "<h2>Pagina no encontrada.</h2>"; 
             } 
    }
   else { include ("tp-content/modulos/taneys/addtaney.php");
    }
?>

...
<!--Inicia header del panel -->
     <title>Skin - &#84;&#97;&#99;&#104;&#105; &#65;&#100;&#109;&#105;&#110; &#80;&#97;&#110;&#101;&#108;</title>
...
<div class="title">Estilos y plantillas</div>
<ul class="menu">
     <li class=""><a href="skin.php?modulo=template">Editar template</a></li>
     <li class=""><a href="skin.php?modulo=style">Editar estilos</a></li>
</ul></div></div>
...
<?php
   if (isset($_GET['modulo'])) {
        $page = $_GET['modulo'];
        if (file_exists("tp-content/modulos/skin/$page.php")) { include ( "tp-content/modulos/skin/$page.php");
         }
        else { 
           print "<h2>Pagina no encontrada.</h2>"; 
             } 
    }
   else { include ("tp-content/modulos/skin/template.php");
    }
?>

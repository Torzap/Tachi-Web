<div class="title">Edici&oacute;n de estilos</div>
...
echo "<center><span style='font-size:14px;'>Estilos del template: <b>$row[7]</b></span></center>";

$fichero = "../tw-content/skin/$row[7]/style.css";
$texto = $_POST["texto"];
if($texto != ''){
...
fclose($fp);
echo "<form method='POST'><textarea id='texto' name='texto' style='width:100%; height:600px;'>$contenido</textarea><br><br /><center><ul style='word-spacing: 5px;'>
<li class='textmenu'><input type='Submit' id='login-submit' value='Guardar' ></li>
<li class='textmenu'><input type='button' id='login-submit' onClick='SelectText(0,1000000)' Value='Seleccionar' ></li>
</ul></center>
</form>
</p>";
?>
